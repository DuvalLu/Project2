...
button.addEventListener("click", function (e) {
  ...
  fetch(
    `https://api.giphy.com/v1/gifs/search?api_key=ioTvN6JBuQyd7qdLS9HQxWgem1AHNkOg&q=${keyword}&limit=12`, //sends a request to giphy api, limit at the end allows only 12 to be returned, has personal api and keyword search item
  )
